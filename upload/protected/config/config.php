...
//                      __/ |
//                     |___/   created by github.com/aerouk, edited to make Discord embeds by JustLeader

/* More information on all these values can be found on the wiki page. */
/* https://github.com/aerouk/imageserve/wiki/Configuration */
/* To edit the embed, go into protected/templates/viewer.phtml and edit the code until <php to your liking.
...
define('TWITTER_HANDLE', '@example');

define('APP_NAME', 'example');
define('PASSKEY', 'Put a password here');
